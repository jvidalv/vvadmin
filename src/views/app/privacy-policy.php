    ...
    <div class="tl_page">
        <main class="tl_article">
            <header class="tl_article_header">
                ...
                <address dir="auto">
                    <a rel="author">Josep Vidal</a>
                    <time datetime="2019-05-10T15:02:57+0000">May 29, 2020</time>
                </address>
            </header>
            <article id="_tl_editor" class="tl_article_content ql-container ql-disabled">
                <div class="ql-editor" contenteditable="false" dir="auto"><h1 data-placeholder="Title"
                                                                              data-label="Title">Privacy Policy</h1>
                    <address data-placeholder="Your name" data-label="Author">Josep Vidal</address>
                    <p>Josep Vidal built his Apps as a Commercial apps. This SERVICE is provided by Josep Vidal and is
                    ...
                    <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
                        which is accessible at Apps unless otherwise defined in this Privacy Policy.</p>
                    <p><strong>Information Collection and Use</strong></p>
                    <p>For a better experience, while using our Service, we may require you to provide us with certain
                        personally identifiable information, including but not limited to a user name, user e-mail, user
                        birthday, user birthplace, user birth time. The information that I request will be retained on
                        your device and is not collected by me in any way.</p>
                    <p>The Apps does use third-party services that may collect information used to identify you.</p>
                    <p>Link to the privacy policy of third party service providers used by the Apps</p>
                    <ul>
                    ...
                    <p>I want to inform you that whenever you use my Service, in the case of an error in the Apps I
                        ...
                        name, operating system version, the configuration of the Apps when utilizing my Service, the
                    ...
                    <p>This Service does not use these “cookies” explicitly. However, the Apps may use third party code
                    ...
                    <p>If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me
                        at josepvidalvidal@gmail.com</p>
